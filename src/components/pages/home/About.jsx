  ...
  return (
    <section id="about" className="w-screen h-screen">
      <div className="flex-col justify-center items-center  mt-30 m-20 space-y-10">
        <h1 className="font-extrabold text-6xl">What is BudgetBuddy ?</h1>
        <h1 className="text-xl w-180">BudgetBuddy is your personal finance sidekick — designed to help you manage your money like a pro without feeling like you're stuck in a spreadsheet dungeon. Built with modern web technologies, it’s here to make budgeting actually useful... and dare we say, fun?</h1>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
        <div className="shadow-2xl p-4 m-10 rounded-xl text-center hover:bg-[#0cec40]/70 hover:-translate-y-1 duration-300 ease-in-out transition-all"> 
          ...
          <p>We analyze your income, spending patterns, and financial goals to give real-time suggestions — not just charts.</p>
        </div>
        <div className="shadow-2xl p-4 m-10 rounded-xl text-center hover:bg-[#0cec40]/70 hover:-translate-y-1 duration-300 ease-in-out transition-all">
